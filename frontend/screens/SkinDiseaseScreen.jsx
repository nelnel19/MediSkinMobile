...
const DISEASE_API_URL = "http://172.34.9.253:8000";
...
const saveToHistory = async () => {
  ...
  try {
    ...
    // FIX: Create a prediction object with proper confidence structure
    const predictionToSave = {
      disease: result.aggregated_result.disease,
      confidence: result.aggregated_result.average_confidence, // Use average_confidence
      description: result.aggregated_result.description,
      medication_info: result.aggregated_result.medication_info,
      warning: result.warning || "",
      is_confident: true,
      is_high_confidence: result.aggregated_result.average_confidence >= 70
    };
    
    formData.append("prediction_result", JSON.stringify(predictionToSave));
